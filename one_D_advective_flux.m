function [T_source,S_source]=one_D_advective_flux(phi_i,S_i,T_i,...
    ice_thickness,grid_size,dt,S_bottom)
...
for i=1:(ice_thickness/grid_size)+1;
    Ra_i(i)=(g*rho_sw*beta*(S_i(i)-S_sw)*min(pi_i(i:end))*(depth-h_i(i)))/(kappa*mu);    % Local Rayleigh #
end
